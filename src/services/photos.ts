...
export class PhotosService {
  ...
  // actual media item. getRequestHeaders() auto-refreshes an expiring token,
  // but a refresh here isn't persisted back to tokens.json (no listener is
  // wired up for that anywhere in this repo) - a pre-existing gap, not new.
